...
async function  scheduleAllTasks(client) {
  ...
  await scheduleTask('publishResultPrediction', '32 15 * * *', () => publishPrediction(client, yesterdayDate));
  await scheduleTask('publishResultPredictionVip', '33 15 * * *', () => publishPrediction(client, yesterdayDate,true));
