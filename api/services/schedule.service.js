...
async function  scheduleAllTasks(client) {
  ...
  await scheduleTask('publishResultPrediction', '44 14 * * *', () => publishPrediction(client, yesterdayDate));
  await scheduleTask('publishResultPredictionVip', '46 14 * * *', () => publishPrediction(client, yesterdayDate,true));
